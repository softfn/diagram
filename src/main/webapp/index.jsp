...
<head>
    ...
    <link type='text/css' rel='stylesheet' href='/themes/default/global_zh.css?1387877189'/>

    <script type="text/javascript" src="/scripts/jquery.js"></script>
    <script type='text/javascript' charset='UTF-8' src='/scripts_bin/zh/util.js?1388393859'></script>
    ...
    <link type='text/css' rel='stylesheet' href='/themes/default/diagraming/designer.css?1388370167'/>

    <link type='text/css' rel='stylesheet' href='/themes/default/diagraming/ui.css?1387172473'/>

    <script type='text/javascript' charset='UTF-8' src='/scripts_bin/zh/diagraming/schema/schema.js?1385547120'></script>
    ...
    <script type='text/javascript' charset='UTF-8' src='/scripts_bin/zh/diagraming/schema/categories/basic.js?1385350374'></script>
    <script type='text/javascript' charset='UTF-8' src='/scripts_bin/zh/diagraming/schema/categories/flow.js?1384420198'></script>
    <script type='text/javascript' charset='UTF-8' src='/scripts_bin/zh/diagraming/schema/categories/bpmn.js?1384420173'></script>
    <script type='text/javascript' charset='UTF-8' src='/scripts_bin/zh/diagraming/schema/categories/evc.js?1384420187'></script>
    <script type='text/javascript' charset='UTF-8' src='/scripts_bin/zh/diagraming/schema/categories/epc.js?1384420180'></script>
    <script type='text/javascript' charset='UTF-8' src='/scripts_bin/zh/diagraming/schema/categories/lane.js?1384420201'></script>
    <script type='text/javascript' charset='UTF-8' src='/scripts_bin/zh/diagraming/schema/categories/er.js?1384420183'></script>
    <script type='text/javascript' charset='UTF-8' src='/scripts_bin/zh/diagraming/schema/categories/uml_common.js?1387356185'></script>
    <script type='text/javascript' charset='UTF-8' src='/scripts_bin/zh/diagraming/schema/categories/uml_usecase.js?1384420231'></script>
    <script type='text/javascript' charset='UTF-8' src='/scripts_bin/zh/diagraming/schema/categories/uml_sequence.js?1384420224'></script>
    <script type='text/javascript' charset='UTF-8' src='/scripts_bin/zh/diagraming/schema/categories/uml_class.js?1384420210'></script>
    <script type='text/javascript' charset='UTF-8' src='/scripts_bin/zh/diagraming/schema/categories/uml_stateactivity.js?1384420227'></script>
    <script type='text/javascript' charset='UTF-8' src='/scripts_bin/zh/diagraming/schema/categories/uml_deployment.js?1384420220'></script>
    <script type='text/javascript' charset='UTF-8' src='/scripts_bin/zh/diagraming/schema/categories/uml_component.js?1384420217'></script>
    <script type='text/javascript' charset='UTF-8' src='/scripts_bin/zh/diagraming/schema/categories/ui.js?1385709967'></script>
    <script type='text/javascript' charset='UTF-8' src='/scripts_bin/zh/diagraming/schema/categories/ui_input.js?1385608011'></script>
    <script type='text/javascript' charset='UTF-8' src='/scripts_bin/zh/diagraming/schema/categories/ios_devices.js?1385628122'></script>
    <script type='text/javascript' charset='UTF-8' src='/scripts_bin/zh/diagraming/schema/categories/ios_elements.js?1385608246'></script>
    <script type='text/javascript' charset='UTF-8' src='/scripts_bin/zh/diagraming/schema/categories/ios_controls.js?1385608276'></script>
    <script type='text/javascript' charset='UTF-8' src='/scripts_bin/zh/diagraming/schema/categories/ios_icons.js?1385608300'></script>
    <script type='text/javascript' charset='UTF-8' src='/scripts_bin/zh/diagraming/schema/categories/org.js?1384420205'></script>
    <script type='text/javascript' charset='UTF-8' src='/scripts_bin/zh/diagraming/schema/categories/venn.js?1385549422'></script>
    <script type="text/javascript">
    ...
    <script type='text/javascript' charset='UTF-8' src='/scripts_bin/zh/diagraming/collaboration.js?1388398162'></script>
    <script type='text/javascript' charset='UTF-8' src='/scripts_bin/zh/diagraming/designer.core.js?1387181926'></script>
    <script type='text/javascript' charset='UTF-8' src='/scripts_bin/zh/diagraming/designer.methods.js?1384420314'></script>
    <script type='text/javascript' charset='UTF-8' src='/scripts_bin/zh/diagraming/designer.events.js?1386231406'></script>
...
<div id="designer_header">
    <div class="titlebar">
        <a class="btn_back" href="/diagraming/back?id=52c5096c0cf22b592924695d" title='返回'><span class="ico ico_goback"></span></a>
        <div class="row row1">
        ...
        <div class="share_container">
            ...
            <div class="user" onmousedown="UI.showUserMenu(event)">
                <img src="/images/default/default/profile-full-male.png"/>softfn
    ...
    <div class="toolbar">
        ...
        <div id="bar_unlock" title='解锁 (Ctrl+Shift+L)' class="toolbar_button"><div class="ico ico_unlock"></div></div>
        <div class="toolbar_small_devider"></div>
        ...
        <a id="bar_return" class="toolbar_button" href="/diagraming/back?id=52c5096c0cf22b592924695d" title='返回'><span class="ico ico_goback"></span></a>
    </div>
</div>
<div id="designer">
...
<div id="dock">
    ...
    <div class="dock_buttons">
        <div id="dock_btn_navigator" title="导航" disableTitle="true" class="toolbar_button selected" onclick="Dock.showView('navigator')"><div class="ico ico_dock_nav"></div></div>
        <div id="dock_btn_graphic" title="图形" disableTitle="true" class="toolbar_button" onclick="Dock.showView('graphic')"><div class="ico ico_dock_styles"></div></div>
        <div id="dock_btn_metric" title="度量" disableTitle="true" class="toolbar_button" onclick="Dock.showView('metric')"><div class="ico ico_dock_metric"></div></div>
        <div id="dock_btn_attribute" title="数据属性" disableTitle="true" class="toolbar_button" onclick="Dock.showView('attribute')"><div class="ico ico_dock_attribute"></div></div>
        <div id="dock_btn_page" title="页面设置" disableTitle="true" class="toolbar_button" onclick="Dock.showView('page')"><div class="ico ico_dock_page"></div></div>
        <div id="dock_btn_history" title="历史版本" disableTitle="true" class="toolbar_button" onclick="Dock.showView('history')"><div class="ico ico_history"></div></div>
    </div>
</div>
    ...
    <div class="footer_content">
        ...
        <div class="content_box">
            <div class="footer_left">
                <div id="open_chat_btn" class="toolbar_button active" onclick="CLB.showChatWin()"><div class="ico ico_chat" style="float: left;"></div>聊天<div id="chat_prompt">0</div></div>

                <div class="footer_devider"></div>
                <div id="collaborators">
                    <img id="chat_user_521dcb690cf20afe916bb48f" src="/images/default/default/profile-full-male.png" title="softfn" title_pos="top" />
            ...
            <ul class="footer_right">
                <li class="footer_chrome"><a href="https://chrome.google.com/webstore/detail/processon-online-diagramm/pnggaliohjcaboolkcpjhfondbjlehkm" target="_blank"><span class="ico chrome"></span>安装到Chrome</a></li>
...
<ul id="bar_list_edit" class="menu list options_menu">
    <li ac="undo"><div class="ico undo"></div>撤销<div class="extend">Ctrl+Z</div></li>
    <li ac="redo"><div class="ico redo"></div>恢复<div class="extend">Ctrl+Y</div></li>
    <li class="devider"></li>
    <li ac="cut"><div class="ico cut"></div>剪切<div class="extend">Ctrl+X</div></li>
    <li ac="copy"><div class="ico copy"></div>复制<div class="extend">Ctrl+C</div></li>
    <li ac="paste"><div class="ico paste"></div>粘贴<div class="extend">Ctrl+V</div></li>
    <li ac="duplicate">复用<div class="extend">Ctrl+D</div></li>
    <li ac="brush"><div class="ico brush"></div>格式刷<div class="extend">Ctrl+Shift+B</div></li>
    <li class="devider"></li>
    <li ac="selectall">全选<div class="extend">Ctrl+A</div></li>
    <li ac="delete"><div class="ico remove"></div>删除<div class="extend">Delete/Backspace</div></li>
</ul>
...
<ul id="bar_list_page" class="menu list options_menu">
    ...
    <li>
        ...
        <ul id="bar_list_pagesize" class="menu list extend_menu menu_ico">
            ...
            <li class="menu_text" style="line-height: 30px;"><span class='lbl'>W:</span><div id="page_size_w" class="spinner active" style="width: 75px;"></div></li>
            <li class="menu_text" style="line-height: 30px;"><span class='lbl'>H:</span><div id="page_size_h" class="spinner active" style="width: 75px;"></div></li>
        </ul>
    </li>
    <li>
...
<ul id="bar_list_arrange" class="menu list options_menu">
    <li ac="front"><div class="ico ico_front"></div>置于顶层<div class="extend">Ctrl+]</div></li>
    <li ac="back"><div class="ico ico_back"></div>置于底层<div class="extend">Ctrl+[</div></li>
    <li ac="forward">上移一层<div class="extend">Ctrl+Shift+]</div></li>
    <li ac="backward">下移一层<div class="extend">Ctrl+Shift+[</div></li>
    <li class="devider"></li>
...
<div id="export_dialog" class="dialog" style="min-width: 450px;">
    ...
    <div class="dialog_content">
        <form id="export_form" action="/diagram_export" method="post">
            ...
            <input type="hidden" name="chartId" value="52c5096c0cf22b592924695d"/>
...
<div class="menu mark_content markcreated_content">
    ...
    <div class="ico dlg_close" onclick="UI.closeGettingStart()"></div>
    <div class="_content">
        <p>在图形边缘的任何地方点击并拖动，您可以创建出一条漂亮的连线。（小圆点是建议的连接点）</p><p>通过小的矩形控制点，您可以改变图形大小。（按住CTRL键可约束比例）</p><p>通过较大的圆点，对图形进行旋转。</p><p>双击可以编辑文本。（CTRL+ENTER保存文本）</p>
    </div>
    <div class="arr-icon left"><div class="arr-border"></div><div class="inner-arr"></div></div>
    <div class="mark_next"><span class="designer_button normal" onclick="UI.closeGettingStart()">关闭</span></div>
</div>
...
<ul id="page_size_list" class="menu list dock_page_menu menu_ico" style="display: none;">
    ...
    <li class="menu_text" style="line-height: 30px;"><span class='lbl'>W:</span><div id="dock_size_w" class="spinner active" style="width: 75px;"></div></li>
    <li class="menu_text" style="line-height: 30px;"><span class='lbl'>H:</span><div id="dock_size_h" class="spinner active" style="width: 75px;"></div></li>
</ul>
...
<div id="disconnected" class="dialog">
    ...
    <div class="dialog_buttons">
        <a class="designer_button" href="/diagraming/52c5096c0cf22b592924695d">重试</a>&nbsp;
        <a class="designer_button normal" href="/diagraming/back?id=52c5096c0cf22b592924695d">关闭</a>
    </div>
</div>
<div id="shapes_dialog" class="dialog" style="width: 400px;">
    ...
    <div class="dialog_content" style="padding: 0px; max-height: 372px; overflow: auto;">
        <ul id="shape_manage_list">
            ...
            <li class="child"><div><input type="checkbox" value="uml_sequence"/>UML 序列图</div></li>
