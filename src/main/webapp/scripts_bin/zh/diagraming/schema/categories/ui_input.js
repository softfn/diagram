...
Schema.addShape({
	...
	drawIcon: function(w, h){
		...
		return [
			{
				fillStyle: {type: "image", fileId: "/images/designer/ui_input/thumb/select.png", imageW: 28, imageH: 10, display: "original"},
				lineStyle: {lineWidth: 0},
				actions: [
					{action: "move", x: x, y: y},
					{action: "line", x: w, y: y},
	...
	path: [
		{
			...
			lineStyle: {lineWidth: 0},
			fillStyle: {type: "image", fileId: "/images/designer/ui_input/search.png", imageX: "4", imageY: "h/2-9", imageW: 16, imageH: 16, display: "static"},
			actions: {ref: "rectangle"}
		}
	],
	drawIcon: function(w, h){
		...
		return [
			{
				fillStyle: {type: "image", fileId: "/images/designer/ui_input/thumb/search.png", imageW: 28, imageH: 10, display: "original"},
				lineStyle: {lineWidth: 0},
				actions: [
					{action: "move", x: x, y: y},
					{action: "line", x: w, y: y},
...
Schema.addShape({
	...
	drawIcon: function(w, h){
		...
		return [
			{
				fillStyle: {type: "image", fileId: "/images/designer/ui_input/thumb/stepper.png", imageW: 30, imageH: 16, display: "original"},
				lineStyle: {lineWidth: 0},
				actions: [
					{action: "move", x: x, y: y},
					{action: "line", x: w, y: y},
	...
	path: [
		{
			...
			lineStyle: {lineWidth: 0},
			fillStyle: {type: "image", fileId: "/images/designer/ui_input/calendar.png", imageX: "w-21", imageY: "h/2-8", imageW: 16, imageH: 16, display: "static"},
			actions: {ref: "rectangle"}
		}
	],
	drawIcon: function(w, h){
		...
		return [
			{
				fillStyle: {type: "image", fileId: "/images/designer/ui_input/thumb/calendar.png", imageW: 30, imageH: 16, display: "original"},
				lineStyle: {lineWidth: 0},
				actions: [
					{action: "move", x: x, y: y},
					{action: "line", x: w, y: y},
...
Schema.addShape({
	...
	drawIcon: function(w, h){
		...
		return [
			{
				fillStyle: {type: "image", fileId: "/images/designer/ui_input/thumb/slider.png", imageW: 30, imageH: 15, display: "original"},
				lineStyle: {lineWidth: 0},
				actions: [
					{action: "move", x: x, y: y},
					{action: "line", x: w, y: y},
	...
	path: [
		{
			...
			lineStyle: {lineWidth: 0},
			fillStyle: {type: "image", fileId: "/images/designer/ui_input/richtext.png", imageX: 5, imageY: 5, imageW: 260, imageH: 20, display: "static"},
			actions: {ref: "rectangle"}
		}
	],
	drawIcon: function(w, h){
		...
		return [
			{
				fillStyle: {type: "image", fileId: "/images/designer/ui_input/thumb/richtext.png", imageW: 23, imageH: 23, display: "original"},
				lineStyle: {lineWidth: 0},
				actions: [
					{action: "move", x: x, y: y},
					{action: "line", x: w, y: y},
