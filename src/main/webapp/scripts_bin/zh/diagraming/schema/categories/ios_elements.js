...
Schema.addShape({
	...
	textBlock: [{
		position: {x: 25, y: 5, w: 80, h: 35}, text: "返回", fontStyle: {textAlign: "left"}
	},{
		position: {x: 190, y: 5, w: 80, h: 35}, text: "操作", fontStyle: {textAlign: "right"}
	}],
	path: [
		{
...
Schema.addShape({
	...
	textBlock: [{
		position: {x: 40, y: 8, w: 200, h: 37}, text: "下载中..."
	}],
	path: [
		{
			lineStyle: {lineWidth: 0},
...
Schema.addShape({
	...
	textBlock: [{
		position: {x: 90, y: 5, w: 100, h: 25}, text: "标题", fontStyle: {bold: true, color: "50,50,50"}
	},{
		position: {x: 185, y: 5, w: 80, h: 25}, text: "取消", fontStyle: {textAlign: "right"}
	},{
		position: {x: 15, y: 37, w: 83, h: 28}, text: "文本"
	},{
		position: {x: 98, y: 37, w: 83, h: 28}, text: "文本", fontStyle: {color: "255,255,255"}
	},{
...
Schema.addShape({
	...
	textBlock: [{
		...
		position: {x: 83, y: 0, w: 83, h: 28}, text: "文本", fontStyle: {color: "255,255,255"}
	},{
...
Schema.addShape({
	...
	textBlock: [{
		...
		position: {x: 202, y: 5, w: 68, h: 35}, text: "取消", fontStyle: {size: 14, textAlign: "center", bold: true}
	}],
	path: [
		{
			fillStyle: {alpha: 0.6},
...
Schema.addShape({
	...
	fontStyle: {size: 14, textAlign: "left"},
	textBlock: [{
		position: {x: 15, y: 5, w: 265, h: "h-10"}, text: "标题"
	}],
	path: [
		{
			lineStyle: {lineWidth: 0},
...
Schema.addShape({
	...
	textBlock: [{
		position: {x: 10, y: 5, w: "w-20", h: "30"}, text: "提示", fontStyle: {size: 14, bold: true}
	},{
		position: {x: 10, y: 35, w: "w-20", h: "h-75"}, text: "提示信息", fontStyle: {vAlign: "top"}
	},{
		position: {x: 5, y: "h-40", w: "w/2-10", h: 40}, text: "确定", fontStyle: {color: "0,122,255"}
	},{
		position: {x: "w/2+5", y: "h-40", w: "w/2-10", h: 40}, text: "取消", fontStyle: {color: "0,122,255"}
	}],
	path: [
		{
...
Schema.addShape({
	...
	textBlock: [{
		position: {x: 0, y: "h*0.4", w: "w", h: "h/5"}, text: "选项 3", fontStyle: {bold: true, color: "0,0,0"}
	},{
