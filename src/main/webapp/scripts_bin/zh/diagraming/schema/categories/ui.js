...
Schema.addShape({
	...
	drawIcon: function(w, h){
		...
		return [
			{
				fillStyle: {type: "image", fileId: "/images/designer/ui/thumb/heading.png", imageW: 30, imageH: 9, display: "original"},
				lineStyle: {lineWidth: 0},
				actions: [
					{action: "move", x: x, y: y},
					{action: "line", x: w, y: y},
...
Schema.addShape({
	...
	drawIcon: function(w, h){
		...
		return [
			{
				fillStyle: {type: "image", fileId: "/images/designer/ui/thumb/label.png", imageW: 26, imageH: 9, display: "original"},
				lineStyle: {lineWidth: 0},
				actions: [
					{action: "move", x: x, y: y},
					{action: "line", x: w, y: y},
...
Schema.addShape({
	...
	drawIcon: function(w, h){
		...
		return [
			{
				fillStyle: {type: "image", fileId: "/images/designer/ui/thumb/paragraph.png", imageW: 26, imageH: 26, display: "original"},
				lineStyle: {lineWidth: 0},
				actions: [
					{action: "move", x: x, y: y},
					{action: "line", x: w, y: y},
...
Schema.addShape({
	...
	drawIcon: function(w, h){
		...
		return [
			{
				fillStyle: {type: "image", fileId: "/images/designer/ui/thumb/link.png", imageW: 26, imageH: 12, display: "original"},
				lineStyle: {lineWidth: 0},
				actions: [
					{action: "move", x: x, y: y},
					{action: "line", x: w, y: y},
...
Schema.addShape({
	...
	drawIcon: function(w, h){
		...
		return [
			{
				fillStyle: {type: "image", fileId: "/images/designer/ui/thumb/browser.png", imageW: 30, imageH: 24, display: "original"},
				lineStyle: {lineWidth: 0},
				actions: [
					{action: "move", x: x, y: y},
					{action: "line", x: w, y: y},
...
Schema.addShape({
	...
	anchors: [],
	textBlock: [{
		position: {x: 10, y: 5, w: "w-40", h: 25}, text: "标题", fontStyle: {vAlign: "middle"}
	},{
	...
	path: [
		{
			...
			fillStyle: {type: "image", fileId: "/images/designer/ui/close.png", imageX: "w-25", imageY: 8, imageW: 20, imageH: 20, display: "static"},
			lineStyle: {lineWidth: 0},
			actions: {ref: "rectangle"}
		}
	],
	drawIcon: function(w, h){
		...
		return [
			{
				fillStyle: {type: "image", fileId: "/images/designer/ui/thumb/dialog.png", imageW: 30, imageH: 30, display: "original"},
				lineStyle: {lineWidth: 0},
				actions: [
					{action: "move", x: x, y: y},
					{action: "line", x: w, y: y},
...
Schema.addShape({
	...
	drawIcon: function(w, h){
		...
		return [
			{
				fillStyle: {type: "image", fileId: "/images/designer/ui/thumb/tab.png", imageW: 30, imageH: 16, display: "original"},
				lineStyle: {lineWidth: 0},
				actions: [
					{action: "move", x: x, y: y},
					{action: "line", x: w, y: y},
...
Schema.addShape({
	...
	drawIcon: function(w, h){
		...
		return [
			{
				fillStyle: {type: "image", fileId: "/images/designer/ui/thumb/video.png", imageW: 30, imageH: 26, display: "original"},
				lineStyle: {lineWidth: 0},
				actions: [
					{action: "move", x: x, y: y},
					{action: "line", x: w, y: y},
...
Schema.addShape({
	...
	drawIcon: function(w, h){
		...
		return [
			{
				fillStyle: {type: "image", fileId: "/images/designer/ui/thumb/scrollbar_v.png", imageW: 10, imageH: 30, display: "original"},
				lineStyle: {lineWidth: 0},
				actions: [
					{action: "move", x: x, y: y},
					{action: "line", x: w, y: y},
...
Schema.addShape({
	...
	drawIcon: function(w, h){
		...
		return [
			{
				fillStyle: {type: "image", fileId: "/images/designer/ui/thumb/scrollbar_h.png", imageW: 30, imageH: 10, display: "original"},
				lineStyle: {lineWidth: 0},
				actions: [
					{action: "move", x: x, y: y},
					{action: "line", x: w, y: y},
...
Schema.addShape({
	...
	fontStyle: {size: 14},
	textBlock: [{
		position: {x: 10, y: -35, h: 25, w: "w-20"}, text: "饼图"
	}],
	path: [
		{
			actions: {ref: "round"}
